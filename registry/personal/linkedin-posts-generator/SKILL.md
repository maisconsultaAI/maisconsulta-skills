...
description: >-
  ...
  contrarian, data-driven, mini-ensaio e híbridos como Cut Through+Analítico), anatomia de post com hook nas
  primeiras linhas, corpo escanável, CTA para comentários elaborados, hashtags 3–5 e checklist pré-publicação.
  Respeita boas práticas do algoritmo (sem link no corpo, dwell time, primeiros 60 minutos). Use quando o
  usuário pedir post ou copy para LinkedIn, conteúdo B2B, thought leadership, autoridade profissional,
  engajamento/alcance na rede, ou quando Cristiano quiser variações e horários ideais para publicação.
license: MIT
---
